...
In molflow, *SPU Device* encapsulates all the concepts of the above SPU, providing a simpler programming interface upwards.

-  Data owners are *PYU devices* in molflow and plaintext of values are called *PYU Objects*.

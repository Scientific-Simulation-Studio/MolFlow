...
def table_statistics(table: Union[pd.DataFrame, VDataFrame]) -> pd.DataFrame:
    ...
    result['moment_2'] = table.select_dtypes(
        'number').pow(2).mean(numeric_only=True)
    result['moment_3'] = table.select_dtypes(
        'number').pow(3).mean(numeric_only=True)
    result['moment_4'] = table.select_dtypes(
        'number').pow(4).mean(numeric_only=True)
    ...
    result['sum_2'] = table.select_dtypes(
        'number').pow(2).sum(numeric_only=True)
    result['sum_3'] = table.select_dtypes(
        'number').pow(3).sum(numeric_only=True)
    result['sum_4'] = table.select_dtypes(
        'number').pow(4).sum(numeric_only=True)
    return result
